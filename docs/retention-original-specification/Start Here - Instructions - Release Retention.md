...
Many software engineers are now using AI assistants such as GitHub Copilot or ChatGPT as part of their daily workflows. We want you to use the tools you know best to complete this exercise and so the use of AI is permitted. We ask that if you are using AI assistance as part of completing the exercise you please answer the following questions in your README.md file: 

- What AI assistant(s) did you use for your exercise?
- What did you ask AI to assist you with and why? For example, did it help you build your retention logic? Or did it help you come up with test cases?
- How useful did you find the AI output? What extra steps did you take before including it in your solution?
